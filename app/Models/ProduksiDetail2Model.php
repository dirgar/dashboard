...
class ProduksiDetail2Model extends Model
{
    protected $table            = 'produksidetail2s';
    ...
    public function getDetail2Afdelings($tdate, $tafd) {           
        ...
        $sql .= "KOTORAN, ABNORMAL, ";
        $sql .= "STANGKUT, KARTU_PANEN, FOTO, EMPCODE, EMPNAME, FOTO_TPH, INPUTDATE, TDATE, SUBSTR(INPUTDATE,10,10) INPUTTIME ";
        $sql .= "FROM MASTERHASILEDIT ";
        $sql .= "WHERE  FIELDCODE = '$tafd' AND TO_DATE (TDATE, 'ddmmyyyy') = TO_DATE ('$tdate', 'MM/DD/YYYY') ";
