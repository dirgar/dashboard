                        ...
                        <li class="nav-item">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <div class="input-group-append">
                                        <div class="input-group-text"><i class="fa fa-calendar text-primary" id="btnDate2"></i></div>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li class="nav-item">
                            <button id="btnCari" type="button" class="btn btn-block btn-primary btn-sm mt-4 ">Cari</button>
                        </li>
                    </ul>
                </div>
            <!-- /.card-body -->
