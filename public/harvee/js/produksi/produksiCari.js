$('#btnCari').click(function() {
    ...
    var td1 = $('#datepicker').datepicker({dateFormat: 'mm-dd-yy'}).datepicker('getDate');
    var td2 =  $('#datepicker2').datepicker({dateFormat: 'mm-dd-yy'}).datepicker('getDate');
    ...
    $("#jsGrid").jsGrid({ 
        ...
        controller: {
            loadData: function(filter) {
                var def = $.Deferred();
                $.ajax({
                url: "http://10.20.10.246:8282/produksiafd/"+tdate1+"/"+tdate2,
                dataType: "json"
